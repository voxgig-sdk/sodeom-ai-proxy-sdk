...
local Ain2Entity = {}
Ain2Entity.__index = Ain2Entity


function Ain2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Ain2Entity)
  self._name = "ain2"
  self._client = client
...
function Ain2Entity:get_name()
  return self._name
end


function Ain2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Ain2Entity.new(self._client, opts)
end


function Ain2Entity:data_set(args)
  if args ~= nil then
...
function Ain2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Ain2Entity:match_set(args)
  if args ~= nil then
...
function Ain2Entity:stream(action, args, callopts)
...
function Ain2Entity:_run_op(ctx, post_done)
  local utility = self._utility
