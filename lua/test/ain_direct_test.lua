...
describe("AinDirect", function()
  it("should direct-load-ain", function()
    local setup = ain_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ain", setup.live and "live" or "unit")
