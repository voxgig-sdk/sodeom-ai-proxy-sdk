...
function runner.env_override(m)
  local live = runner.getenv("SODEOM_AI_PROXY_TEST_LIVE")
  local override = runner.getenv("SODEOM_AI_PROXY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SODEOM_AI_PROXY_TEST_EXPLAIN")
