...
function runner.env_override(m)
  local live = runner.getenv("SODEOMAIPROXY_TEST_LIVE")
  local override = runner.getenv("SODEOMAIPROXY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SODEOMAIPROXY_TEST_EXPLAIN")
