...
describe("AinEntity", function()
  it("should create instance", function()
    local testsdk = sdk.test(nil, nil)
    local ent = testsdk:Ain(nil)
  ...
  it("should run basic flow", function()
    ...
    assert.is_nil(err)
    assert.is_not_nil(ain_ref01_data_dt0_loaded)

  end)
end)

function ain_basic_setup(extra)
  runner.load_env_local()

  local entity_data_file = _test_dir .. "../../.sdk/test/entity/ain/AinTestData.json"
  local f = io.open(entity_data_file, "r")
  if f == nil then
    error("failed to read ain test data: " .. entity_data_file)
  end
