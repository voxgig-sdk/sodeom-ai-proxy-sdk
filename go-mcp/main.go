// Command SodeomAiProxy-mcp is an MCP server exposing the SodeomAiProxy
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SodeomAiProxy_list  — list records of an entity
//	SodeomAiProxy_load  — load a single record of an entity
//
