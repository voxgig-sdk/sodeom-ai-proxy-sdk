...
func registerTools(server *mcp.Server, client *sdk.SodeomAiProxySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "sodeom-ai-proxy_list",
		Description: "List records from SodeomAiProxy. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "sodeom-ai-proxy_load",
		Description: "Load a single record from SodeomAiProxy. " +
...
func runOp(client *sdk.SodeomAiProxySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SodeomAiProxySDK, name string) (sdk.SodeomAiProxyEntity, error) {
