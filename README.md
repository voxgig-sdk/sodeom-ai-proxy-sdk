...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/sodeom-ai-proxy` | `npm install @voxgig-sdk/sodeom-ai-proxy` |
| Python | `voxgig-sdk-sodeom-ai-proxy` | `pip install voxgig-sdk-sodeom-ai-proxy` |
| PHP | `voxgig-sdk/sodeom-ai-proxy` | `composer require voxgig-sdk/sodeom-ai-proxy` |
| Golang | `github.com/voxgig-sdk/sodeom-ai-proxy-sdk/go` | `go get github.com/voxgig-sdk/sodeom-ai-proxy-sdk/go` |
| Ruby | `voxgig-sdk-sodeom-ai-proxy` | `gem install voxgig-sdk-sodeom-ai-proxy` |
| Lua | `voxgig-sdk-sodeom-ai-proxy` | `luarocks install voxgig-sdk-sodeom-ai-proxy` |
