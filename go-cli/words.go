...
func registerSDKWords(r *eng.Registry, client *sdk.SodeomAiProxySDK) {
...
func runOp(client *sdk.SodeomAiProxySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
