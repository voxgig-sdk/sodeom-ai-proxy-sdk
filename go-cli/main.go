// Command SodeomAiProxy-cli is a CLI + REPL for the SodeomAiProxy SDK,
...
const prompt = "sodeom-ai-proxy"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "ain ain2"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      SODEOM_AI_PROXY_APIKEY (api key), SODEOM_AI_PROXY_BASE (base url override)")
