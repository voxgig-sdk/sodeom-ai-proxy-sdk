...
class Ain2Entity
  ...
  # @return [Ain2, Hash] the current Ain2 data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Ain2 fields)
  def match_get
  ...
  # Create a new Ain2.
  #
  # @param reqdata [Ain2CreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Ain2, Hash] the created Ain2; raises SodeomAiProxyError on failure
