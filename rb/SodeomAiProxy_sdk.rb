...
require_relative 'SodeomAiProxy_types'
...
class SodeomAiProxySDK
  ...
  def get_utility
    SodeomAiProxyUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = SodeomAiProxyHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = SodeomAiProxyHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = SodeomAiProxyHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = SodeomAiProxyHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = SodeomAiProxyError.new(
        "graphql_error", "SodeomAiProxySDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = SodeomAiProxySDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
