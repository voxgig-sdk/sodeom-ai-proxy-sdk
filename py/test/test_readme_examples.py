# SodeomAiProxy SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SodeomAiProxySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SodeomAiProxySDK(...) and SodeomAiProxySDK.test(...) become
#      SodeomAiProxySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "sodeomaiproxy_sdk"
_SDK_CLASS = "SodeomAiProxySDK"
