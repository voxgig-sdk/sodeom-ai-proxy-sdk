...
class SodeomAiProxyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SodeomAiProxyTestRunner.getenv("SODEOMAIPROXY_TEST_LIVE")
        override = SodeomAiProxyTestRunner.getenv("SODEOMAIPROXY_TEST_OVERRIDE")
        ...
        explain = SodeomAiProxyTestRunner.getenv("SODEOMAIPROXY_TEST_EXPLAIN")
