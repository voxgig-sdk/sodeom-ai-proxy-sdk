...
class TestAinDirect:
    ...
    def test_should_direct_load_ain(self):
        setup = _ain_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-ain", "live" if setup["live"] else "unit")
        if _skip:
