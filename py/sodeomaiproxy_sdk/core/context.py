...
from sodeomaiproxy_sdk.core.control import SodeomAiProxyControl
...
from sodeomaiproxy_sdk.core.helpers import get_ctx_prop, to_map
...
class SodeomAiProxyContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = SodeomAiProxyControl()
        ...
        if isinstance(sp, SodeomAiProxySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SodeomAiProxyResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SodeomAiProxyResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return SodeomAiProxyError(code, msg, self)
