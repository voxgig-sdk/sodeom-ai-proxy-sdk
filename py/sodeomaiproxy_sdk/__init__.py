...
from sodeomaiproxy_sdk.utility import register

# Load features
from sodeomaiproxy_sdk.feature.base_feature import SodeomAiProxyBaseFeature
from sodeomaiproxy_sdk.features import _has_feature, _make_feature
...
class SodeomAiProxySDK:
    ...
    def get_utility(self):
        return SodeomAiProxyUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SodeomAiProxySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Ain(self, data=None) -> "AinEntity":
        ...
        from sodeomaiproxy_sdk.entity.ain_entity import AinEntity
