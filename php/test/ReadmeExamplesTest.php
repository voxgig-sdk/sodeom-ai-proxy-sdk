...
// SodeomAiProxy SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SodeomAiProxySDK::test)
...
{
    private const SDK_CLASS = 'SodeomAiProxySDK';
    ...
    private const SDK_BASE = 'sodeomaiproxy_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../sodeomaiproxy_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
