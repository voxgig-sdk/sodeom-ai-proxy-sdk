...
// SodeomAiProxy SDK utility type

class SodeomAiProxyUtility
{
    ...
    public static function copy(SodeomAiProxyUtility $src): SodeomAiProxyUtility
    {
        $u = new SodeomAiProxyUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
