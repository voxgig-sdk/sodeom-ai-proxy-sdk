...
class SodeomAiProxySDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = SodeomAiProxyHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = SodeomAiProxyHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!SodeomAiProxyFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, SodeomAiProxyFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return SodeomAiProxyUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = SodeomAiProxyHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = SodeomAiProxyHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = SodeomAiProxyHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new SodeomAiProxyError($op . "_allow",
                "SodeomAiProxySDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = SodeomAiProxyHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new SodeomAiProxyError("graphql_error",
                "SodeomAiProxySDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Ain($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_ain === null) {
                $this->_ain = new AinEntity($this, null);
            }
            return $this->_ain;
        }
        return new AinEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new SodeomAiProxySDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
