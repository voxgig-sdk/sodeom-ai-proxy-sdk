...
// SodeomAiProxy SDK utility: fetcher

class SodeomAiProxyFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SodeomAiProxySDK/1.0)';
    ...
    public static function call(SodeomAiProxyContext $ctx, string $fullurl, array $fetchdef): array
    {
