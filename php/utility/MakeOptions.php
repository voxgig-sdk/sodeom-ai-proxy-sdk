...
// SodeomAiProxy SDK utility: make_options

class SodeomAiProxyMakeOptions
{
    ...
    public static function call(SodeomAiProxyContext $ctx): array
    {
        ...
        //
        // `SodeomAiProxySchema::optspec()` is built from the model:
        ...
        $optspec = SodeomAiProxySchema::optspec();
