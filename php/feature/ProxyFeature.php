...
// SodeomAiProxy SDK proxy feature
...
class SodeomAiProxyProxyFeature extends SodeomAiProxyBaseFeature
{
    ...
    public function init(SodeomAiProxyContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SodeomAiProxyContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
