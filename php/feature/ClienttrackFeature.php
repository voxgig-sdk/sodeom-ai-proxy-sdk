...
// SodeomAiProxy SDK clienttrack feature
...
class SodeomAiProxyClienttrackFeature extends SodeomAiProxyBaseFeature
{
    ...
    public function PostConstruct(SodeomAiProxyContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SodeomAiProxy-SDK';
