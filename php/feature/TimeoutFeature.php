...
// SodeomAiProxy SDK timeout feature
...
class SodeomAiProxyTimeoutFeature extends SodeomAiProxyBaseFeature
{
    ...
    private function _with_timeout(SodeomAiProxyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SodeomAiProxyContext $_ctx, float $ms): void
    {
        $client = $this->client;
