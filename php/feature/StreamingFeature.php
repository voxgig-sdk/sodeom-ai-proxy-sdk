...
// SodeomAiProxy SDK streaming feature
...
class SodeomAiProxyStreamingFeature extends SodeomAiProxyBaseFeature
{
    ...
    private function _iterate(SodeomAiProxyResult $result): \Generator
    {
    ...
    private function _streamable(SodeomAiProxyContext $ctx): bool
    {
