...
// SodeomAiProxy SDK debug feature
...
class SodeomAiProxyDebugFeature extends SodeomAiProxyBaseFeature
{
    ...
    private function _finish(SodeomAiProxyContext $ctx, bool $ok): void
    {
