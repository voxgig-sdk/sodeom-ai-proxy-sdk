...
// SodeomAiProxy SDK netsim feature
...
class SodeomAiProxyNetsimFeature extends SodeomAiProxyBaseFeature
{
    ...
    private function _simulate(SodeomAiProxyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SodeomAiProxyContext $ctx, array $applied): void
    {
        $client = $this->client;
