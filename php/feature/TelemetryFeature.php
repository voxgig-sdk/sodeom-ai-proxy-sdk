...
// SodeomAiProxy SDK telemetry feature
...
class SodeomAiProxyTelemetryFeature extends SodeomAiProxyBaseFeature
{
    ...
    private function _close(SodeomAiProxyContext $ctx, bool $ok): void
    {
