...
// SodeomAiProxy SDK rbac feature
...
class SodeomAiProxyRbacFeature extends SodeomAiProxyBaseFeature
{
    ...
    private function _required(SodeomAiProxyContext $ctx): ?string
    {
    ...
    private function _reject(SodeomAiProxyContext $ctx, string $required): void
    {
    ...
    private function _track(SodeomAiProxyContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
