...
// SodeomAiProxy SDK metrics feature
...
class SodeomAiProxyMetricsFeature extends SodeomAiProxyBaseFeature
{
    ...
    private function _record(SodeomAiProxyContext $ctx, bool $ok): void
    {
