...
The PHP SDK for the SodeomAiProxy API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Ain(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->SodeomAiProxy(null)->load(
    ["id" => "test01"], null
);
