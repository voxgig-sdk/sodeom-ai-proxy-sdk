# SodeomAiProxy PHP SDK



The PHP SDK for the SodeomAiProxy API — an entity-oriented client using PHP conventions.
...
```
php/
├── sodeomaiproxy_sdk.php          -- Main SDK class
...
The main class (`sodeomaiproxy_sdk.php`) exports the SDK class
