# SodeomAiProxy PHP SDK Reference

Complete API reference for the SodeomAiProxy PHP SDK.
...
#### `SodeomAiProxySDK::test($testopts = null, $sdkopts = null)`
...
```php
[$result, $err] = $client->Ain()->load(["id" => "ain_id"]);
```
