...
class SodeomAiProxyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SodeomAiProxyTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SodeomAiProxyTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SodeomAiProxyTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
