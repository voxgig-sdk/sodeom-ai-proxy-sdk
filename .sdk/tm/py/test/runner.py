...
class SodeomAiProxyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SodeomAiProxyTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = SodeomAiProxyTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = SodeomAiProxyTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
