...
// SodeomAiProxy SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class SodeomAiProxyMakeRequest
{
    public static function call(SodeomAiProxyContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new SodeomAiProxyResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new SodeomAiProxyResponse($fetched);
        } else {
