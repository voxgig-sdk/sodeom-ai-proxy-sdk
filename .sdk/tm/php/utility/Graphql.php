...
// SodeomAiProxy SDK utility: graphql
//
...
class SodeomAiProxyGraphql
{
    ...
    // equivalent.
    public static function body(SodeomAiProxyContext $ctx): mixed
    {
    ...
    public static function errors(SodeomAiProxyContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
