...
// SodeomAiProxy SDK idempotency feature
...
class SodeomAiProxyIdempotencyFeature extends SodeomAiProxyBaseFeature
{
    ...
    private function _mutating(SodeomAiProxyContext $ctx): bool
    {
