...
// SodeomAiProxy SDK ratelimit feature
...
class SodeomAiProxyRatelimitFeature extends SodeomAiProxyBaseFeature
{
    ...
    private function _acquire(SodeomAiProxyContext $ctx): void
    {
    ...
    private function _track(SodeomAiProxyContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
