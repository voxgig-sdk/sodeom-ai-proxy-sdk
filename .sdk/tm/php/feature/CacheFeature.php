...
// SodeomAiProxy SDK cache feature
...
class SodeomAiProxyCacheFeature extends SodeomAiProxyBaseFeature
{
    ...
    private function _through(SodeomAiProxyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
