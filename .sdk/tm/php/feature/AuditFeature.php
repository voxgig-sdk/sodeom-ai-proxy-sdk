...
// SodeomAiProxy SDK audit feature
...
class SodeomAiProxyAuditFeature extends SodeomAiProxyBaseFeature
{
    ...
    private function _emit(SodeomAiProxyContext $ctx, string $outcome): void
    {
