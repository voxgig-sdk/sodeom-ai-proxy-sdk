...
|---|---|---|
| `ts/` | @voxgig-sdk/sodeom-ai-proxy-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/sodeom-ai-proxy-sdk \
      --repository voxgig-sdk/sodeom-ai-proxy-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/sodeom-ai-proxy-sdk` shows it, and
`npm trust revoke @voxgig-sdk/sodeom-ai-proxy-sdk --id=<id>` removes it.
