...
func (sdk *SodeomAiProxySDK) OptionsMap() map[string]any {
...
func (sdk *SodeomAiProxySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *SodeomAiProxySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *SodeomAiProxySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SodeomAiProxySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *SodeomAiProxySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *SodeomAiProxySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("SodeomAiProxySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *SodeomAiProxySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SodeomAiProxySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("SodeomAiProxySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *SodeomAiProxySDK {
	...
	sdk := NewSodeomAiProxySDK(sdkopts)
	sdk.Mode = "test"
