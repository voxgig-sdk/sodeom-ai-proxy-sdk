...
const testSeed = `map[string]any{"entity": map[string]any{"ain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ain2": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
