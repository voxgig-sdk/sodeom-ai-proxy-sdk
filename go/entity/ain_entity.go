...
type AinEntity struct {
	name    string
	client  *core.SodeomAiProxySDK
...
func NewAinEntity(client *core.SodeomAiProxySDK, entopts map[string]any) *AinEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AinEntity) GetName() string { return e.name }
...
func (e *AinEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AinEntity) Deleted() bool {
	return e.deleted
}


func (e *AinEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAinEntity(e.client, opts)
}

func (e *AinEntity) Data(args ...any) any {
...
func (e *AinEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Ain; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AinEntity) DataTyped(data ...Ain) Ain {
	if len(data) > 0 {
		return typedFrom[Ain](e.Data(asMap(data[0])))
	}
	return typedFrom[Ain](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Ain (all fields
// optional at the wire level).
func (e *AinEntity) MatchTyped(match ...Ain) Ain {
	if len(match) > 0 {
		return typedFrom[Ain](e.Match(asMap(match[0])))
	}
	return typedFrom[Ain](e.Match())
}
...
func (e *AinEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AinEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AinLoadMatch and returns an Ain. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AinEntity) LoadTyped(reqmatch AinLoadMatch, ctrl map[string]any) (Ain, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Ain{}, err
	}
	return typedFrom[Ain](res), nil
}



func (e *AinEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AinEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AinCreateData and returns an Ain. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AinEntity) CreateTyped(reqdata AinCreateData, ctrl map[string]any) (Ain, error) {
...
func (e *AinEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AinEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AinEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
