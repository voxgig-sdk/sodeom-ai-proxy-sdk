...
// instead of `sdk.NewSodeomAiProxySDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *SodeomAiProxySDK  { return NewSodeomAiProxySDK(nil) }
func Test() *SodeomAiProxySDK { return TestSDK(nil, nil) }
