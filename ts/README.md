# SodeomAiProxy TypeScript SDK



The TypeScript SDK for the SodeomAiProxy API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Ain()` — each with a small set of operations (`load`, `create`)
...
| Method | Returns | Description |
| --- | --- | --- |
| `SodeomAiProxySDK.test(testopts?, sdkopts?)` | `SodeomAiProxySDK` | Create a test-mode client. |
...
| `client` | `client(): SodeomAiProxySDK` | Return the parent SDK client. |
...
sodeom-ai-proxy/
├── src/
│   ├── SodeomAiProxySDK.ts        # Main SDK class
