...
(0, node_test_1.describe)('AinDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.SodeomAiProxySDK({
    ...
    (0, node_test_1.test)('direct-load-ain', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ain', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.SODEOM_AI_PROXY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SodeomAiProxySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SODEOM_AI_PROXY_TEST_AIN_ENTID'];
    ...
    const client = new __1.SodeomAiProxySDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AinDirect.test.js.map